...
namespace GADE_Task2_19013066
{
    ...
    { 
        ...
        public override void Move(int dir)
        {
            switch (dir)
            {
                case 0: YPos--; break; //Moves North
                case 1: XPos++; break; //Moves East
                case 2: YPos++; break; //Moves South
                case 3: XPos--; break; //Moves West
                default: break;
            }
        }
        ...
        public override (Building, int) Closest(List<Building> building)
        {
            int shortest = 100;
            ...
            foreach (Building u in building)
            {
                if (u is ResourceBuilding)
                {
                    ...
                    int distance = Math.Abs(this.XPos - otherMu.BuildPosX)
                               + Math.Abs(this.YPos - otherMu.BuildPosY);
                ...
                else if (u is FactoryBuilding)
                {
                    ...
                    int distance = Math.Abs(this.XPos - otherRu.BuildPosX)
                               + Math.Abs(this.YPos - otherRu.BuildPosY);
                    if (distance < shortest)
                    {
                        shortest = distance;
                        closest = otherRu;
